...
class Processor(object):
    ...
    '''
    def __init__(self, tosca_service_template=None, configuration=None, type_system=None, processor=None):
        if processor != None:
    ...
    def is_tosca_definitions_version_file(self):
        ...
        if tosca_definitions_version:
            ...
            result = path.endswith('/profiles/' + tosca_definitions_version + '/types.yaml') or path.endswith(tosca_definitions_version + '.yaml')
            return result
        return False
...
class Generator(Processor):
    ...
    def __init__(self, tosca_service_template=None, configuration=None, type_system=None, generator=None):
        Processor.__init__(self, tosca_service_template, configuration, type_system, generator)
        if generator != None:
    ...
    def get_filename(self, tosca_service_template):
        ...
        if format == "fullname":
            return tosca_service_template.get_fullname().replace('./', '').replace('/', '-')
        else:
