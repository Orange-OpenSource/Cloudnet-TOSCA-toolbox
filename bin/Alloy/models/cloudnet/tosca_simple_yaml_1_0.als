...
sig tosca_nodes_WebApplication extends tosca_nodes_Root
{
  ...
  // YAML context_root: {'type': 'string'}
  property_context_root: one string,
...
sig tosca_nodes_Database extends tosca_nodes_Root
{
  ...
  // YAML port: {'type': 'integer', 'description': 'the port the underlying database service will listen to for data'}
  //
  // the port the underlying database service will listen to for data
  //
  property_port: one integer,
...
sig tosca_nodes_Abstract_Storage extends tosca_nodes_Root
{
  ...
  // YAML size: {'type': 'scalar-unit.size', 'default': '0 MB', 'constraints': [{'greater_or_equal': '0 MB'}]}
