...
sig tosca_datatypes_TimeInterval extends tosca_datatypes_Root
{
  ...
  // YAML start_time: {'type': 'timestamp', 'required': True}
  start_time: one timestamp,

  // YAML end_time: {'type': 'timestamp', 'required': True}
...
sig tosca_capabilities_Compute extends tosca_capabilities_Root
{
  // --------------------------------------------------
  // Properties
  // --------------------------------------------------
...
sig tosca_capabilities_Container extends tosca_capabilities_Compute
{
} {
}
...
sig tosca_nodes_Storage_ObjectStorage extends tosca_nodes_Root
{
  // --------------------------------------------------
  // Properties
  // --------------------------------------------------
...
sig tosca_nodes_Storage_BlockStorage extends tosca_nodes_Root
{
  // --------------------------------------------------
  // Properties
  // --------------------------------------------------
